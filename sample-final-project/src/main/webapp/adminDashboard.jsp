...
<div class="sidebar">
    ...
    <a href="artist-management.jsp">Artist Management</a>
    <a href="artwork-management.jsp">Artwork Management</a>
    <a href="order-management.jsp">Order Management</a>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text" id="user-count">120</p> <!-- This will be dynamically updated from the database -->
                </div>
            </div>
        </div>
        <!-- Artist Count -->
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text" id="artist-count">45</p> <!-- This will be dynamically updated -->
                </div>
            </div>
        </div>
        <!-- Artwork Count -->
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text" id="artwork-count">350</p> <!-- This will be dynamically updated -->
                </div>
            </div>
        </div>
        <!-- Order Count -->
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text" id="order-count">75</p> <!-- This will be dynamically updated -->
                </div>
            </div>
        </div>
    </div>
